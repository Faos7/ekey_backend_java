jQuery(document).ready(function($) {
	...
	$.ajax({
		...
		showMeYourJqXHR('When GET /university is done', jqXHR);
		showMeYourCookies('When GET /university is done');
		...
		showMeYourJqXHR('When GET /university fails', jqXHR);
		showMeYourCookies('When GET /university fails');
